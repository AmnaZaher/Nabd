                    ...
                    <tbody className="divide-y divide-slate-50">
                      {exams.length === 0 ? (
                        ...
                        exams.map((exam) => {
                          ...
                          const canStart = exam.radiologistName && exam.radiologistName !== "—";
                          return (
                            <tr key={exam.id} className="hover:bg-slate-50/20 transition-colors">
                              ...
                              <td className="px-8 py-6">
                                <div className="flex items-center justify-center gap-2">
                                  <button
                                    onClick={() => canStart && handleStartExam(exam.id, exam.modality)}
                                    disabled={startingExamId === exam.id || !canStart}
                                    className={`px-4 py-2 text-xs font-black uppercase tracking-wider rounded-xl transition-all shadow-sm whitespace-nowrap disabled:opacity-50 ${
                                      !canStart 
                                        ? "bg-slate-200 text-slate-400 cursor-not-allowed"
                                        : isEmergency
                                        ? "bg-red-600 hover:bg-red-750 text-white shadow-red-100 cursor-pointer"
